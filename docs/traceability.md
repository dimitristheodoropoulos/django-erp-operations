...
| ----------- | ---------------------------- | ------------------------------------------- | ------------- | ----------- | ------------------------------ | ------------------------------------ | ---- | ------------------------------ | ----------- |
| ERP-REQ-001 | Customer Creation            | `architecture.md` / Customers               | `database.md` | `models.md` | `customers/0001_initial.py`    | —                                    | —    | —                              | DESIGNED    |
| ERP-REQ-002 | Customer Retrieval           | `architecture.md` / Customers               | `database.md` | `models.md` | `customers/0001_initial.py`    | —                                    | —    | —                              | DESIGNED    |
| ERP-REQ-003 | Customer Status              | `architecture.md` / Customers               | `database.md` | `models.md` | `customers/0001_initial.py`    | —                                    | —    | —                              | DESIGNED    |
